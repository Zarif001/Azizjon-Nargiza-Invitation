  ...
  return (
    <div className="bg-slate-100 pt-24">
      <AnimatedSection animation={textRight} className="grid grid-cols-2 items-center h-[350px]" >
        <p className="text-sm font-vibes text-center"> <span className="text-m mb-[1px] block "><b>Navkar and Fotixa Toy</b></span> <br /> <span className="text-m font-bold">Тайминг</span> <br />12:00 - Начало помолвки, <br />обмен дарами, <br />14:00 - Приветсвие невесты <br />с мамой жениха, <br />15:00 "Домод Салом" приветствие жениха с родственниками невесты, <br /> 16:00 национальные танцы,<br />  продолжение банкета <br /></p> 
        <img
